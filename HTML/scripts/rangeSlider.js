  ...
  (t.cleanData = (function (e) {
    ...
    (t.widget = function (e, i, s) {
      ...
      return (
        ...
        (o.prototype = t.widget.extend(
          ...
          u,
          { constructor: o, namespace: r, widgetName: e, widgetFullName: h }
        )),
        n
        ...
        return (
          a
            ? this.length || "instance" !== o
              ...
              : (r = void 0)
            : (u.length && (o = t.widget.extend.apply(null, [o].concat(u))),
              this.each(function () {
                var e = t.data(this, n);
                e
      ...
      _on: function (e, i, s) {
        ...
        "boolean" != typeof e && ((s = i), (i = e), (e = !1)),
          ...
          t.each(s, function (s, a) {
            ...
            "string" != typeof a &&
              (u.guid = a.guid = a.guid || u.guid || t.guid++);
            var r = s.match(/^([\w:-]*)\s*(.*)$/),
    ...
    t.each({ show: "fadeIn", hide: "fadeOut" }, function (e, i) {
      t.Widget.prototype["_" + e] = function (s, n, o) {
        "string" == typeof n && (n = { effect: n });
        var a,
          u = n ? (!0 === n || "number" == typeof n ? i : n.effect || i) : e;
        "number" == typeof (n = n || {}) && (n = { duration: n }),
          (a = !t.isEmptyObject(n)),
          (n.complete = o),
          n.delay && s.delay(n.delay),
          a && t.effects && t.effects.effect[u]
            ? s[e](n)
            : u !== e && s[u]
            ? s[u](n.duration, n.easing, o)
            : s.queue(function (i) {
                t(this)[e](), o && o.call(s[0]), i();
              });
      };
